...
const recipeControllers = {
    ...
    getOne: async (req, res) => {
        try {
            ...
            console.log('Recipe fetched:', recipe); // Log to verify book data
    ...
    addRecipe: async (req, res) => {
        ...
        try {
            // Decodifica il token dal cookie
            const token = req.cookies.token;
            if (!token) {
            ...
            const user_id = decoded.id; // Ottieni l'ID dell'utente dal token
            ...
            const recipe = {
                ...
                ingredients,
                img,
                user_id // Associa la ricetta all'utente loggato
            };
